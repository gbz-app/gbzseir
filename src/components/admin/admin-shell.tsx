...
export const ADMIN_NAV: AdminNavItem[] = [
  ...
  { href: routes.admin.gebzemai(), label: "GebzemAI", icon: Sparkles },
  ...
  { href: routes.admin.events(), label: "Etkinlikler", icon: Ticket },
  { href: routes.admin.serviceCategories(), label: "Hizmet kategorileri", icon: FolderTree },
  { href: routes.admin.listingCategories(), label: "İlan kategorileri", icon: Tags },
  { href: routes.admin.vocabularies(), label: "Kategori sözlükleri", icon: Library },
  ...
  { href: routes.admin.newsArticles(), label: "Haber yazıları", icon: PenLine },
  { href: routes.admin.announcements(), label: "Duyurular", icon: Megaphone },
  { href: routes.admin.places(), label: "Yerler", icon: MapPinned },
  { href: routes.admin.guide(), label: "Şehir rehberi", icon: Signpost },
  { href: routes.admin.duty(), label: "Nöbet listesi", icon: Pill },
