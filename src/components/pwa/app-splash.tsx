 ...
 * "Akse Digital" 50 px above the bottom, for about two seconds each time the app is opened (once per tab session), then
...
export function AppSplash() {
  return (
    <>
      ...
      >
        <Image src="/brand/logo-mark.webp" alt="" width={120} height={120} priority className="size-30" />
        <span className="absolute inset-x-0 bottom-[calc(50px+env(safe-area-inset-bottom,0px))] text-center text-[15px] font-semibold tracking-wide text-neutral-900/70">
          Akse Digital
        </span>
      </div>
    </>
