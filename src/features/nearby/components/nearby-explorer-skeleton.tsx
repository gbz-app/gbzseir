...
/**
 * Loading state of the explore screen (/yakinimda, /rehber/[kategori]): map placeholder and the list sheet with its
 * title and chip row (the chips live in the sheet, nothing sits on the map). Server-safe.
 */
export function NearbyExplorerSkeleton() {
  return (
    <div className={NEARBY_AREA_CLASS} role="status" aria-label="Yükleniyor">
      ...
      <div className="absolute inset-x-0 bottom-0 h-[55%] overflow-hidden rounded-t-3xl bg-background px-4 pt-3 shadow-[0_-10px_30px_-12px_rgb(0_0_0/0.25)]">
